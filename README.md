...
This repository contains only the compiled Vite production build (a single
self-contained bundle — no CDN externals, real hashed image files). The
source app, tests, and Android/Capacitor project stay private.
