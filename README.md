...
This preview is from **PR #14** branch `cursor/year-photos-wheels-2b74` for Ted’s review — **not merged to `main`**.

Vehicle year photos load from Wikimedia Commons FilePath URLs. Scene photos use Unsplash source images. Wheel graphics are inline SVGs. App JS is published as text parts (same GHA/text path as the prior PR14 preview).
