    ...
    score: 86,
    defaults: { dailyMiles: 55, stops: 7, payloadWeight: 650, trailerWeight: 0, equipmentIds: ["hand-tool-chargers", "irrigation-heads-valves", "irrigation-pipe"] },
  },
  { name: "Parking-Access / Gate Service", score: 86 },
  { name: "Fence & Gate Installer / Service", score: 86 },
  { name: "Garage Door Installation & Service", score: 86 },
  { name: "Handyman (Residential / Commercial)", score: 86 },
  { name: "Glass & Mirror Installer", score: 85 },
  { name: "Nursery / Landscape Installation", score: 85 },
  { name: "Delivery Business (Light Work Trucks)", score: 85 },
  { name: "Landscaping / Lawn Maintenance", score: 85 },
  {
    id: "battery-lawn",
    name: "Battery-Powered Lawn / Landscaping",
    score: 85,
    featured: true,
    defaults: {
      dailyMiles: 48,
      ...
      payloadWeight: 900,
      trailerWeight: 0,
      equipmentIds: ["battery-mower", "lawn-pack-chargers", "ope-hand-chargers", "extra-battery-packs", "handheld-ope-kit", "crew-trailer"],
    },
  },
  { name: "Dealership / Mobile Service Vehicles", score: 85 },
  { name: "Elevator Service Technicians", score: 84 },
  { name: "Insurance Catastrophe / Field Inspectors", score: 84 },
  { name: "Surveying Company", score: 84 },
  { name: "Engineering Field-Service Crew", score: 84 },
  { name: "Environmental / Testing Technician", score: 84 },
  { name: "Drywall / Service Contractor", score: 83 },
  { name: "Construction Supervisor / Superintendent", score: 82 },
  { name: "Rental Equipment Service Technician", score: 82 },
  { name: "Mobile Detailing", score: 82 },
  { name: "Mobile Windshield Repair", score: 81 },
  { name: "Cable-Locating / Utility Locating", score: 80 },
  { name: "Food & Beverage Route Support", score: 80 },
  { name: "Home Builder / General Contractor", score: 78 },
  { name: "Roofing Support / Service Trucks", score: 78 },
  { name: "Generator Service Technicians", score: 78 },
  { name: "Commercial Laundry-Equipment Service", score: 78 },
  { name: "Marine Service Technician", score: 78 },
  { name: "Boat / Marina Maintenance", score: 78 },
  { name: "Construction Punch-List Crews", score: 78 },
  { name: "Cemetery Maintenance", score: 77 },
  { name: "Golf-Course Maintenance Support", score: 77 },
  { name: "Mobile Mechanic", score: 77 },
  {
    id: "pressure-washing",
    name: "Pressure Washing / Exterior Cleaning",
    score: 76,
    defaults: { dailyMiles: 50, stops: 5, payloadWeight: 550, trailerWeight: 0, equipmentIds: ["pressure-washer", "pw-hose-reel", "freshwater-tote"] },
  },
  { name: "Home-Health Equipment Delivery / Service", score: 75 },
  { name: "Laboratory-Equipment Service", score: 75 },
  { name: "Refrigeration Service", score: 75 },
  { name: "Boat Electronics Installers", score: 75 },
  { name: "Tree Service / Arborist", score: 75 },
  { name: "Carpenter / Framing Contractor", score: 74 },
  { name: "Welding / Mobile Fabrication", score: 74 },
  { name: "Concrete & Masonry", score: 74 },
  { name: "Towing Company Support / Service Trucks", score: 74 },
  { name: "Waste / Recycling Support Vehicles (Non-Collection)", score: 73 },
  { name: "Boat-Detailing / Service Fleets", score: 73 },
  { name: "Septic Inspection / Service", score: 71 },
  { name: "Pool Construction Service / Support", score: 71 },
  { name: "Commercial Refrigeration Install / Service", score: 70 },
  { name: "Junk Removal & Hauling", score: 70 },
  { name: "Agriculture Service / Farm-Support Fleet", score: 68 },
  { name: "Oil & Gas Field Support (Local Routes Only)", score: 55 },
  { name: "Mining / Site-Support Pickups (Selective)", score: 55 },
  { name: "Commercial Snow / Winter Ops Support", score: 55 },
];
...
// UI dropdown only. Hard cap 10 including the type-your-trade path.
// TRADES / TRADES_RAW above is the research library — do not delete it.
...
export function resolveTradeProfile(tradeName, customText = "") {
  ...
  // Type-your-trade: generic field-service kit, no assumed convertibility %.
  if (major.id === "other") {
    return {
      ...other,
      score: null,
